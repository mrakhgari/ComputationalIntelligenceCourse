...
# np.random.seed()  # set seed value so that the results are reproduceable
...
for epoch in range(number_of_epochs):
    ...
    # ---------------------- Compute Cost ----------------------------
    cost, dA1, accuracy_rate = compute_bce_cost(Y_train, Z1.Z)
...
Z1.forward(X_test)
# ---------------------- Compute Cost ----------------------------
cost, dA1, accuracy_rate = compute_bce_cost(Y_test, Z1.Z)
